    ...
    var body: some View {
        ...
        Form {
            ...
            Section("Legend") {
                ...
                LegendRow("Click a PR to open it on GitHub. Double-click or ⌘-click to expand it: description, failing checks, and buttons for Open, Copy URL, Share, Pin, and Fix with your agent. Right-click for the rest.") { HStack(spacing: 6) { Image(systemName: "arrow.up.right"); Image(systemName: "doc.on.doc"); Image(systemName: "square.and.arrow.up"); Image(systemName: "pin"); Image(systemName: "terminal") }.font(.caption).foregroundStyle(.secondary) }
